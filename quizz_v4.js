...
function check(){
	...
	//const url = 'http://8.210.189.74:3000/';
	...
	.then((json) => {
		...
		var pictures = ["https://i.imgur.com/f3K9Li1.png", "https://i.imgur.com/rzKYJmy.jpg", "https://i.imgur.com/VVy3q22.gif"];
		var messages = ["Ha ha hay lắm, scan cái code này và và... tự biết =)), trả lời được câu hỏi thì chả có gì lắm đâu :))", "That's just okay but yeah you have to know me more", "Hah nice try but you have to know me more"];
